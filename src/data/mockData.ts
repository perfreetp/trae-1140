...
export const requisitions: Requisition[] = [
  { id: 'req1', reqNo: 'REQ-2026-0001', workOrderId: 'wo1', applicant: '李强', status: 'pending', urgent: true, needsApproval: true, approver: '王主管', createdAt: '2026-06-07', items: [{ id: 'ri1', partId: 'sp1', quantity: 1, substituted: false, originalPartId: '' }] },
  { id: 'req2', reqNo: 'REQ-2026-0002', workOrderId: 'wo2', applicant: '赵明', status: 'approved', urgent: false, needsApproval: true, approver: '王主管', createdAt: '2026-06-07', items: [{ id: 'ri2', partId: 'sp8', quantity: 1, substituted: false, originalPartId: '' }, { id: 'ri3', partId: 'sp10', quantity: 1, substituted: false, originalPartId: '' }] },
  { id: 'req3', reqNo: 'REQ-2026-0003', workOrderId: 'wo3', applicant: '孙华', status: 'shipped', urgent: false, needsApproval: true, approver: '王主管', createdAt: '2026-06-06', items: [{ id: 'ri4', partId: 'sp14', quantity: 1, substituted: false, originalPartId: '' }, { id: 'ri5', partId: 'sp26', quantity: 2, substituted: false, originalPartId: '' }] },
  { id: 'req4', reqNo: 'REQ-2026-0004', workOrderId: 'wo4', applicant: '李强', status: 'pending', urgent: false, needsApproval: false, approver: '', createdAt: '2026-06-06', items: [{ id: 'ri6', partId: 'sp5', quantity: 1, substituted: false, originalPartId: '' }] },
  { id: 'req5', reqNo: 'REQ-2026-0005', workOrderId: 'wo6', applicant: '李强', status: 'pending', urgent: true, needsApproval: true, approver: '刘经理', createdAt: '2026-06-05', items: [{ id: 'ri7', partId: 'sp4', quantity: 1, substituted: false, originalPartId: '' }] },
  { id: 'req6', reqNo: 'REQ-2026-0006', workOrderId: 'wo7', applicant: '赵明', status: 'approved', urgent: false, needsApproval: true, approver: '王主管', createdAt: '2026-06-05', items: [{ id: 'ri8', partId: 'sp11', quantity: 1, substituted: false, originalPartId: '' }] },
  { id: 'req7', reqNo: 'REQ-2026-0007', workOrderId: 'wo8', applicant: '孙华', status: 'shipped', urgent: false, needsApproval: false, approver: '', createdAt: '2026-06-04', items: [{ id: 'ri9', partId: 'sp17', quantity: 1, substituted: false, originalPartId: '' }] },
  { id: 'req8', reqNo: 'REQ-2026-0008', workOrderId: 'wo9', applicant: '李强', status: 'shipped', urgent: false, needsApproval: false, approver: '', createdAt: '2026-06-03', items: [{ id: 'ri10', partId: 'sp3', quantity: 1, substituted: false, originalPartId: '' }] },
  { id: 'req9', reqNo: 'REQ-2026-0009', workOrderId: 'wo11', applicant: '孙华', status: 'rejected', urgent: false, needsApproval: true, approver: '王主管', createdAt: '2026-06-04', items: [{ id: 'ri11', partId: 'sp15', quantity: 1, substituted: true, originalPartId: 'sp14' }] },
  { id: 'req10', reqNo: 'REQ-2026-0010', workOrderId: 'wo13', applicant: '周伟', status: 'pending', urgent: false, needsApproval: true, approver: '王主管', createdAt: '2026-06-03', items: [{ id: 'ri12', partId: 'sp33', quantity: 1, substituted: false, originalPartId: '' }] },
]
