...
export const requisitions: Requisition[] = [
  { id: 'req1', reqNo: 'REQ-2026-0001', workOrderId: 'wo1', applicant: '李强', warehouseId: 'wh1', status: 'pending', urgent: true, needsApproval: true, approver: '王主管', createdAt: '2026-06-07', items: [{ id: 'ri1', partId: 'sp1', quantity: 1, substituted: false, originalPartId: '' }], courier: '', trackingNo: '', reserveDate: '', reserveTech: '', auditTrail: [{ action: 'created', actor: '李强', timestamp: '2026-06-07 09:30', detail: '创建申领单' }] },
  { id: 'req2', reqNo: 'REQ-2026-0002', workOrderId: 'wo2', applicant: '赵明', warehouseId: 'wh1', status: 'approved', urgent: false, needsApproval: true, approver: '王主管', createdAt: '2026-06-07', items: [{ id: 'ri2', partId: 'sp8', quantity: 1, substituted: false, originalPartId: '' }, { id: 'ri3', partId: 'sp10', quantity: 1, substituted: false, originalPartId: '' }], courier: '', trackingNo: '', reserveDate: '', reserveTech: '', auditTrail: [{ action: 'created', actor: '赵明', timestamp: '2026-06-07 10:15', detail: '创建申领单' }, { action: 'approved', actor: '王主管', timestamp: '2026-06-07 11:00', detail: '审批通过' }] },
  { id: 'req3', reqNo: 'REQ-2026-0003', workOrderId: 'wo3', applicant: '孙华', warehouseId: 'wh2', status: 'shipped', urgent: false, needsApproval: true, approver: '王主管', createdAt: '2026-06-06', items: [{ id: 'ri4', partId: 'sp14', quantity: 1, substituted: false, originalPartId: '' }, { id: 'ri5', partId: 'sp26', quantity: 2, substituted: false, originalPartId: '' }], courier: '顺丰速运', trackingNo: 'SF2233445566', reserveDate: '', reserveTech: '', auditTrail: [{ action: 'created', actor: '孙华', timestamp: '2026-06-06 08:00', detail: '创建申领单' }, { action: 'approved', actor: '王主管', timestamp: '2026-06-06 09:30', detail: '审批通过' }, { action: 'shipped', actor: '王主管', timestamp: '2026-06-06 14:00', detail: '已出库，顺丰速运 SF2233445566' }] },
  { id: 'req4', reqNo: 'REQ-2026-0004', workOrderId: 'wo4', applicant: '李强', warehouseId: 'wh3', status: 'pending', urgent: false, needsApproval: false, approver: '', createdAt: '2026-06-06', items: [{ id: 'ri6', partId: 'sp5', quantity: 1, substituted: false, originalPartId: '' }], courier: '', trackingNo: '', reserveDate: '', reserveTech: '', auditTrail: [{ action: 'created', actor: '李强', timestamp: '2026-06-06 11:20', detail: '创建申领单' }] },
  { id: 'req5', reqNo: 'REQ-2026-0005', workOrderId: 'wo6', applicant: '李强', warehouseId: 'wh1', status: 'pending', urgent: true, needsApproval: true, approver: '刘经理', createdAt: '2026-06-05', items: [{ id: 'ri7', partId: 'sp4', quantity: 1, substituted: false, originalPartId: '' }], courier: '', trackingNo: '', reserveDate: '', reserveTech: '', auditTrail: [{ action: 'created', actor: '李强', timestamp: '2026-06-05 16:00', detail: '创建紧急申领单' }] },
  { id: 'req6', reqNo: 'REQ-2026-0006', workOrderId: 'wo7', applicant: '赵明', warehouseId: 'wh4', status: 'approved', urgent: false, needsApproval: true, approver: '王主管', createdAt: '2026-06-05', items: [{ id: 'ri8', partId: 'sp11', quantity: 1, substituted: false, originalPartId: '' }], courier: '', trackingNo: '', reserveDate: '', reserveTech: '', auditTrail: [{ action: 'created', actor: '赵明', timestamp: '2026-06-05 09:45', detail: '创建申领单' }, { action: 'approved', actor: '王主管', timestamp: '2026-06-05 10:30', detail: '审批通过' }] },
  { id: 'req7', reqNo: 'REQ-2026-0007', workOrderId: 'wo8', applicant: '孙华', warehouseId: 'wh5', status: 'shipped', urgent: false, needsApproval: false, approver: '', createdAt: '2026-06-04', items: [{ id: 'ri9', partId: 'sp17', quantity: 1, substituted: false, originalPartId: '' }], courier: '京东物流', trackingNo: 'JD9988776655', reserveDate: '', reserveTech: '', auditTrail: [{ action: 'created', actor: '孙华', timestamp: '2026-06-04 13:00', detail: '创建申领单' }, { action: 'shipped', actor: '王主管', timestamp: '2026-06-04 15:30', detail: '已出库，京东物流 JD9988776655' }] },
  { id: 'req8', reqNo: 'REQ-2026-0008', workOrderId: 'wo9', applicant: '李强', warehouseId: 'wh1', status: 'shipped', urgent: false, needsApproval: false, approver: '', createdAt: '2026-06-03', items: [{ id: 'ri10', partId: 'sp3', quantity: 1, substituted: false, originalPartId: '' }], courier: '中通快递', trackingNo: 'ZT1122334455', reserveDate: '', reserveTech: '', auditTrail: [{ action: 'created', actor: '李强', timestamp: '2026-06-03 08:30', detail: '创建申领单' }, { action: 'shipped', actor: '王主管', timestamp: '2026-06-03 11:00', detail: '已出库，中通快递 ZT1122334455' }] },
  { id: 'req9', reqNo: 'REQ-2026-0009', workOrderId: 'wo11', applicant: '孙华', warehouseId: 'wh2', status: 'rejected', urgent: false, needsApproval: true, approver: '王主管', createdAt: '2026-06-04', items: [{ id: 'ri11', partId: 'sp15', quantity: 1, substituted: true, originalPartId: 'sp14' }], courier: '', trackingNo: '', reserveDate: '', reserveTech: '', auditTrail: [{ action: 'created', actor: '孙华', timestamp: '2026-06-04 14:20', detail: '创建申领单(含替代件)' }, { action: 'rejected', actor: '王主管', timestamp: '2026-06-04 16:00', detail: '驳回：替代件不适用' }] },
  { id: 'req10', reqNo: 'REQ-2026-0010', workOrderId: 'wo13', applicant: '周伟', warehouseId: 'wh3', status: 'pending', urgent: false, needsApproval: true, approver: '王主管', createdAt: '2026-06-03', items: [{ id: 'ri12', partId: 'sp33', quantity: 1, substituted: false, originalPartId: '' }], courier: '', trackingNo: '', reserveDate: '', reserveTech: '', auditTrail: [{ action: 'created', actor: '周伟', timestamp: '2026-06-03 10:00', detail: '创建申领单' }] },
]

export const transfers: Transfer[] = [
  { id: 'tf1', transferNo: 'TF-2026-0001', fromWarehouseId: 'wh1', toWarehouseId: 'wh3', sourceRequisitionId: 'req3', status: 'shipping', courier: '顺丰速运', trackingNo: 'SF1234567890', createdAt: '2026-06-07', items: [{ id: 'ti1', partId: 'sp1', quantity: 2 }, { id: 'ti2', partId: 'sp3', quantity: 5 }] },
  { id: 'tf2', transferNo: 'TF-2026-0002', fromWarehouseId: 'wh2', toWarehouseId: 'wh1', sourceRequisitionId: '', status: 'received', courier: '中通快递', trackingNo: 'ZT9876543210', createdAt: '2026-06-06', items: [{ id: 'ti3', partId: 'sp8', quantity: 3 }] },
  { id: 'tf3', transferNo: 'TF-2026-0003', fromWarehouseId: 'wh3', toWarehouseId: 'wh4', sourceRequisitionId: 'req6', status: 'pending', courier: '', trackingNo: '', createdAt: '2026-06-06', items: [{ id: 'ti4', partId: 'sp14', quantity: 2 }, { id: 'ti5', partId: 'sp16', quantity: 1 }] },
  { id: 'tf4', transferNo: 'TF-2026-0004', fromWarehouseId: 'wh1', toWarehouseId: 'wh5', sourceRequisitionId: '', status: 'shipping', courier: '京东物流', trackingNo: 'JD2024060500001', createdAt: '2026-06-05', items: [{ id: 'ti6', partId: 'sp5', quantity: 4 }, { id: 'ti7', partId: 'sp7', quantity: 2 }] },
  { id: 'tf5', transferNo: 'TF-2026-0005', fromWarehouseId: 'wh4', toWarehouseId: 'wh2', sourceRequisitionId: '', status: 'received', courier: '顺丰速运', trackingNo: 'SF0987654321', createdAt: '2026-06-04', items: [{ id: 'ti8', partId: 'sp11', quantity: 1 }] },
  { id: 'tf6', transferNo: 'TF-2026-0006', fromWarehouseId: 'wh5', toWarehouseId: 'wh3', sourceRequisitionId: '', status: 'pending', courier: '', trackingNo: '', createdAt: '2026-06-03', items: [{ id: 'ti9', partId: 'sp19', quantity: 3 }, { id: 'ti10', partId: 'sp20', quantity: 5 }] },
  { id: 'tf7', transferNo: 'TF-2026-0007', fromWarehouseId: 'wh2', toWarehouseId: 'wh4', sourceRequisitionId: '', status: 'shipping', courier: '韵达快递', trackingNo: 'YD5678901234', createdAt: '2026-06-02', items: [{ id: 'ti11', partId: 'sp33', quantity: 2 }] },
]
